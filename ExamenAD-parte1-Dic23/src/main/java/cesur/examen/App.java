 ...
 * Diciembre 2023
 *
 * Nombre del alumno: Javier Sánchez Carreras
 * Fecha: 11/12/2023
 */
public class App 
{
    ...
    static final String STUDENT_NAME = "Javier Sánchez";
    ...
    public static void main( String[] args )
    {
        ...
        System.out.print("Trying to update Worker... ");
        oldest = WorkerService.renovateWorker( oldest.getDni() );
        System.out.println(oldest.toString() + " update trabajador set nombre=?, dni=?. desde=? where id=?");
